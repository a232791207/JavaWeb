...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="col-lg-12">  
        	<div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">待审核的新闻</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">新闻信息
                        ...
                        <div class="panel-body">
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
		                   		...
		                   		<div class="row">
		                   			<div class="col-sm-12">
		                   			<c:if test="${num==0}"><font color="#FF0000">暂时没有需要审核的新闻！</font></c:if>
		                   			<c:if test="${num!=0}">
		                   				<table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">		
		                   				                               
		                           <tbody>  
		                           <form action="${pageContext.request.contextPath }/pages/admin/updateNews?id=${news.id}" method="post">       
	                                   ...
	                                   <td>                      		
										    <div id="myCarousel" class="carousel slide">  
												<div class="carousel-inner">
													...
													<img src="${pageContext.request.contextPath }/images/news/tmp/news.png?<%=date.toLocaleString() %>" alt="First slide">
													</div>
												</div>
											</div>
	                                   </td>
