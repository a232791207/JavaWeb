                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="${pageContext.request.contextPath }/pages/cooperater/notice!noticePage2?thispage=1&state=1&user=admin">更多</a>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		url="${pageContext.request.contextPath }/pages/cooperater/notice!noticeBriefInfo";
		$.post(url,
 			{
