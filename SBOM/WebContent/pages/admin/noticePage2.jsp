        ...
        <div id="page-wrapper">
           <div class="row">
              <div class="col-lg-12">
                  ...
                  <a href="${pageContext.request.contextPath }/pages/admin/index.jsp">返回</a>
              </div>
          </div>
          <!-- /.row -->
          <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div style="text-align:center;">
										...
										<a href="notice!noticePage2?thispage=${requestScope.page.firstpage}&state=${requestScope.state}&user=admin">首页</a>
										<a href="notice!noticePage2?thispage=${requestScope.page.prepage}&state=${requestScope.state}&user=admin">上一页</a>
										...
										<c:forEach begin="${begin }" end="${end }" step="1" var="i">
											...
											<c:if test="${requestScope.page.thispage != i }">
												<a href="notice!noticePage2?thispage=${i}&state=${requestScope.state}&user=admin">${i }</a>
											</c:if>
										</c:forEach>
										<!-- 分页逻辑结束 -->
										
										<a href="notice!noticePage2?thispage=${requestScope.page.nextpage}&state=${requestScope.state}&user=admin">下一页</a>
										<a href="notice!noticePage2?thispage=${requestScope.page.lastpage}&state=${requestScope.state}&user=admin">尾页</a>
									</div> 
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
