        ...
        <div id="page-wrapper" class="col-lg-12">  
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                           		...
                           		<div class="row">
                           			<form action="notice!upload?user=admin" method="post" enctype="multipart/form-data">
                           			<div class="col-sm-12">
                    ...
                    <a href="notice!noticePage?thispage=1&state=1&user=cooperater">已接受的公告</a>
                    <a href="notice!noticePage?thispage=1&state=0&user=cooperater">待处理的公告</a>
                    <a href="notice!noticePage?thispage=1&state=-1&user=cooperater">被拒绝的公告</a>
                    <!-- /.panel -->
                </div>
                <!-- /.col-lg-12 -->
            </div>
