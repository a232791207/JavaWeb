                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                               	...
                                               	<tr>
                                               		...
                                               		<td>
                                               			<s:form action="removeBinding!remove" method="post">
                                               				...
                                               				<s:submit value="解绑" align="center" onclick="return confirmAccept()"></s:submit>
                                               			</s:form>
                                               		</td>
                                               	</tr>
                                               </c:forEach>
                                    ...
                                    <div style="text-align:center;">
										...
										<a href="subordinatePage.action?thispage=${requestScope.page.firstpage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=0">首页</a>
										<a href="subordinatePage.action?thispage=${requestScope.page.prepage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=0">上一页</a>
										...
										<c:forEach begin="${begin }" end="${end }" step="1" var="i">
											...
											<c:if test="${requestScope.page.thispage != i }">
												<a href="subordinatePage.action?thispage=${i}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=0">${i }</a>
											</c:if>
										</c:forEach>
										<!-- 分页逻辑结束 -->
										
										<a href="subordinatePage.action?thispage=${requestScope.page.nextpage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=0">下一页</a>
										<a href="subordinatePage.action?thispage=${requestScope.page.lastpage}&&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=0">尾页</a>
									</div> 
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
