                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel-heading">
	               		<form action="subordinatePage!subordinateByID" method="post">
	               			...
	               			<input type="hidden" id="subLevel" name="subLevel" value="2"/>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>代理列表
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                            ...
                                            <tbody>
                                              <c:forEach items="${requestScope.page.list }" var="subordinate">
                                               	<tr>
                                               		...
                                               		<td>
                                               			<c:out value="${subordinate.phoneNum }" />
                                               		</td>
                                               		<td>
                                               		...
                                               		<td>
                                               			<c:out value="${subordinate.inviteNum }" />
                                               		</td>
                                               	</tr>
                                               </c:forEach>
                                            </tbody>
                                    ...
                                    <div style="text-align:center;">
										...
										<a href="subordinatePage.action?thispage=${requestScope.page.firstpage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=2">首页</a>
										<a href="subordinatePage.action?thispage=${requestScope.page.prepage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=2">上一页</a>
										...
										<c:forEach begin="${begin }" end="${end }" step="1" var="i">
											...
											<c:if test="${requestScope.page.thispage != i }">
												<a href="subordinatePage.action?thispage=${i}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=2">${i }</a>
											</c:if>
										</c:forEach>
										<!-- 分页逻辑结束 -->
										
										<a href="subordinatePage.action?thispage=${requestScope.page.nextpage}&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=2">下一页</a>
										<a href="subordinatePage.action?thispage=${requestScope.page.lastpage}&&supUserName=${sessionScope.user.userName}&days=${requestScope.days}&subLevel=2">尾页</a>
									</div> 
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
