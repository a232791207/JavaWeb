...
<body>
	<c:if test="${sessionScope.user==null }">
		...
		window.parent.location.href="${pageContext.request.contextPath }/pages/loginagent.jsp";
		</script>
	</c:if>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="panel panel-primary">
                      <div class="panel-heading">新增人数：<font id="newIncrease">0</font>
                      </div>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="panel panel-green">
                      <div class="panel-heading">总用户数：<font id="sumNum">0</font>
                      </div>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="panel panel-yellow">
                      <div class="panel-heading">今日活跃：<font id="todayActive">0</font>
                      </div>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="panel panel-red">
                      <div class="panel-heading">今日消费：<font id="todayConsumption">0</font>
                      </div>
                  </div>
              </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="${pageContext.request.contextPath }/pages/cooperater/notice!noticePage2?thispage=1&state=1&user=agent">更多</a>
                        </div>
                        <!-- /.panel-heading -->
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		url="subordinateAction!overview";
		$.post(url,
 			{
				supUserName:$("#supUserName").val()
			},
			function(data){
				var value = data.split(",");
				$("#newIncrease").text(value[0]);
				$("#sumNum").text(value[1]);
				$("#todayActive").text(value[2]);
				$("#todayConsumption").text(value[3]);
			}
		);
		url="rechargeApplyNum!num";
		$.post(url,
 			{
				supUserName:$("#supUserName").val()
			},
			function(data){
				if(data>0){
					var a = "<a href='rechargeApply.action?thispage=1&stime=&etime=&supUserName=${sessionScope.user.userName }'>您有"+data+"个新的充值申请待处理！<\a>";
					$(a).appendTo("#head");
				}
			}
		);
