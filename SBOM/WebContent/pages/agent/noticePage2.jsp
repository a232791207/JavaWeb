        ...
        <div id="page-wrapper">
           <div class="row">
              <div class="col-lg-12">
                  ...
                  <a href="${pageContext.request.contextPath }/pages/agent/index.jsp">返回</a>
              </div>
          </div>
          <!-- /.row -->
          <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                            ...
                                            <tbody>
                                              <c:forEach items="${requestScope.page.list }" var="notice">
                                               	<tr>
                                               		...
                                               		<td>
                                               		  <a href="${pageContext.request.contextPath }/pages/cooperater/notice!noticeInfo?id=${notice.id }&user=agent">
                                    ...
                                    <div style="text-align:center;">
										...
										<a href="notice!noticePage2?thispage=${requestScope.page.firstpage}&state=${requestScope.state}&user=agent">首页</a>
										<a href="notice!noticePage2?thispage=${requestScope.page.prepage}&state=${requestScope.state}&user=agent">上一页</a>
										...
										<c:forEach begin="${begin }" end="${end }" step="1" var="i">
											...
											<c:if test="${requestScope.page.thispage != i }">
												<a href="notice!noticePage2?thispage=${i}&state=${requestScope.state}&user=agent">${i }</a>
											</c:if>
										</c:forEach>
										<!-- 分页逻辑结束 -->
										
										<a href="notice!noticePage2?thispage=${requestScope.page.nextpage}&state=${requestScope.state}&user=agent">下一页</a>
										<a href="notice!noticePage2?thispage=${requestScope.page.lastpage}&state=${requestScope.state}&user=agent">尾页</a>
									</div> 
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
