        ...
        <div id="page-wrapper" class="col-lg-10">
            ...
            <div class="row">
                <div class="panel-heading">
               		<form action="rechargeApply!applyed">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <s:a href="rechargeApply.action?thispage=1&stime=&etime=&supUserName=%{#session.user.userName }">未完成</s:a>
                            	已完成
                        </div>
