...
public class PrintOrderListForTreasurerServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		OrderPage orderPage = service.pageOrderByStatement(from, to*10, "未审核");
		...
		String name="orderListForTreasurer.xls";
        ...
        try {    
            ...
            // 创建一个工作表
            WritableSheet ws = wwb.createSheet("订单列表",2);       
        ...
        response.getWriter().write("文件保存在"+fileName+"中");
        //让客户端下载这个excel文件
