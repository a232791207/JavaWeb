...
public class PrintFreightListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		FarePage farePage = service.getFreightByPage(from, to*10);
        ...
        try {    
            ...
            // 创建一个工作表
            WritableSheet ws = wwb.createSheet("运费信息查询表", 1);       
            ...
            ws.addCell(new Label(3, 1, "运费单价(元/立方米)", wcf));
            ws.addCell(new Label(4, 1, "体积(立方米)", wcf));
            ws.addCell(new Label(5, 1, "总运费(元)", wcf));
