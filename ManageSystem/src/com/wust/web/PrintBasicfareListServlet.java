...
public class PrintBasicfareListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		BasicFarePage basicFarePage = service.getBasicFareByPage(from, to*10);
        ...
        try {    
            ...
            // 创建一个工作表
            WritableSheet ws = wwb.createSheet("调度费表", 1);       
            ...
            ws.addCell(new Label(2, 1, "调度费单价(元/立方米)", wcf));
