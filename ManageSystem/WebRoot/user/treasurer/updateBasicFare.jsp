...
<html>
  ...
  <body style="text-align: center;">
  	...
  	<h2>修改基本调度费项</h2><hr/>
  	<br/><br/><br/><br/><br/>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/servlet/UpdateBasicFareServlet" method="post">
	        ...
	        <div class="form-group">
				...
				<label class="col-sm-2 control-label">调度费单价(元/立方米)</label>
				<div class="col-sm-2">
   ...
   <script type="text/javascript">
  	...
  	$(document).ready(function(){
  		url = "<%=request.getContextPath() %>/servlet/BasicFareInfoServlet";
