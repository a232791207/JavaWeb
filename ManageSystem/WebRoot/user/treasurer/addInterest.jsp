...
<html>
  ...
  <body style="text-align: center;">
  	...
  	<h2>新增返利</h2><hr/>
  	<br/><br/><br/><br/><br/>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/servlet/AddInterestServlet" method="post">
			...
			<div class="form-group">
				<label class="col-sm-5 control-label">返利金额(元)</label>
				<div class="col-sm-2">
