...
public class JSONHelper {
	public static String SerializeWithNeedAnnotation(Object obj)
	{
		Gson gs=new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();   
		return gs.toJson(obj);
	}
	public static String SerializeWithOutInnerClass(Object obj)
	{
		Gson gs=new GsonBuilder().disableInnerClassSerialization().create();   
		return gs.toJson(obj);
	}
	
	public static String SerializeWithOutInnerdate(Object obj)
	{
		Gson gs=new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").disableInnerClassSerialization().create();   
		return gs.toJson(obj);
	}
	...
	public static String toJson(Object target, Type targetType,
		...
		if (StringHelper.isBlank(datePattern))
