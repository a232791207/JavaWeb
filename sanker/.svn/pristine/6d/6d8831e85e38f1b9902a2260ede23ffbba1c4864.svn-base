...
(function (h, k, j, e) {
	...
	function f(s) {
		var u = {65505:{app:"EXIF", name:"APP1", signature:"Exif\x00"}, 65506:{app:"ICC", name:"APP2", signature:"ICC_PROFILE\x00"}, 65517:{app:"IPTC", name:"APP13", signature:"Photoshop 3.0\x00"}}, t = [], r, n, p = e, q = 0, o;
		r = new b();
		r.init(s);
		if (r.SHORT(0) !== 65496) {
			return;
	...
	function a() {
		...
		return {init:function (u) {
			...
			q.init(u);
			if (q.SHORT(0) === 65505 && q.STRING(4, 5).toUpperCase() === "EXIF\x00") {
				return s();
			}
			return false;
		}, EXIF:function () {
